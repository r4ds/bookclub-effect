...
Welcome to the The Effect: An Introduction to Research Design and Causality book club! 

This website is a companion for the book [_The Effect: An Introduction to Research Design and Causality_](https://theeffectbook.net/index.html) by Nick Huntington-Klein (copyright January 5, 2022).
This companion is available at [dslc.io/effect](https://dslc.io/effect).
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-effect).
